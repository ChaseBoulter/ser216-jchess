...
public class PawnTest {
    ...
    public void setUp() throws Exception {
        for (int i = 0, j = 1; i <= 7; i++, j++) {
            ...
            blackPawns1[i] = new Pawn(fileSeparator + "Icons" + fileSeparator + "Player2Icons"
                    + fileSeparator + "BlackPawn.png", j, 2);
        }

        for (int i = 0, j = 1; i <= 7; i++, j++) {
            whitePawns2[i] = new Pawn(fileSeparator + "Icons" + fileSeparator + "Player1Icons"
                    + fileSeparator + "WhitePawn.png", j, 5);
            whitePawns3[i] = new Pawn(fileSeparator + "Icons" + fileSeparator + "Player1Icons"
                    + fileSeparator + "WhitePawn.png", j, 3);
            blackPawns2[i] = new Pawn(fileSeparator + "Icons" + fileSeparator + "Player2Icons"
