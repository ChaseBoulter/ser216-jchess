...
public class Player1 {
    ...
    public Player1() {
        ...
        this.whiteKnight1 = new Knight(fileSeparator + "Icons" + fileSeparator + "Player1Icons"
                + fileSeparator + "whiteKnight.png", 2, 8);
        this.whiteKnight2 = new Knight(fileSeparator + "Icons" + fileSeparator + "Player1Icons"
                + fileSeparator + "whiteKnight.png", 7, 8);
        this.whiteBishop1 = new Bishop(fileSeparator + "Icons" + fileSeparator + "Player1Icons"
                + fileSeparator + "whiteBishop.png", 3, 8);
        this.whiteBishop2 = new Bishop(fileSeparator + "Icons" + fileSeparator + "Player1Icons"
                + fileSeparator + "whiteBishop.png", 6, 8);
        ...
        int j = 1;
        for (int i = 0; i <= 7; i++, j++) {
            this.whitePawns[i] = new Pawn(fileSeparator + "Icons" + fileSeparator + "Player1Icons"
